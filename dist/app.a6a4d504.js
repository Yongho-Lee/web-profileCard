...
module.exports = /*#__PURE__*/function () {
  ...
  _createClass(Email, [{
    ...
    value: function render() {
      ...
      link.href = "mailto:".concat(this.email); //mailto:someone.com
...
var ProfileCard = /*#__PURE__*/function () {
  ...
  _createClass(ProfileCard, [{
    ...
    value: function render() {
      ...
      section.className = 'profile-card'; //section.innerHTML = this.name;
...
function init() {
  ...
  load().then(function (users) {
    ...
    users.forEach(function (user) {
      ...
      var avatarUrl = user.avatar; // console.log(id, name, email, avatarUrl);
